...
```
⏳ Répartition des points Summer League — confirmer (1 pt prono + 2 pts fourchette)
...
| v2.3 | 2026-06-08 | Bloc CONTEXTE COTES livré (ESPN pickcenter + The Odds API + cache Supabase) |

---

*Document de référence Swish League — roadmap produit*
*Ne pas fusionner avec socle_nba_v4_0.md (référence technique)*
