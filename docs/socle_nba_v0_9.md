...
src/
  ...
  data/
    changelog.js       — CHANGELOG[] + VERSION_COURANTE (v0.9)
  services/
...
✅ Changelog versionné v0.9, accessible depuis hamburger
...
- [ ] Calcul points côté serveur (Edge Function)
- [ ] Leaders stats NBA via proxy Supabase Edge Function (CORS bloqué)

## Backlog Sprint 2
- [ ] Page Stats/Explorer : classements NBA par saison, fiches équipes, fiches joueurs
- [ ] Entrée dans le menu hamburger → page Stats/Explorer
...
- [ ] News FR via RSS + proxy Edge Function (actuellement ESPN EN uniquement)
- [ ] StandingsNBA : TOP 5 + lien vers page Stats/Explorer
