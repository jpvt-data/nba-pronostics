# SWISH LEAGUE — SOCLE v4.4
> Document de référence unique — technique et organisationnel
> Mis à jour le 2026-06-09 (session 5)
...
Voir socle v4.3 pour le détail.
...
### Sprints 1→3.8 + Cotes + Sessions 3→5 ✅ LIVRÉS
...
|---|---|---|
| `socle_nba_v4_4.md` | Référence technique unique | ✅ Ce document |
| `swish_league_roadmap_v2_7.md` | Vision produit, roadmap | ✅ Actif |
| `espn_capacites_v1_2.md` | Cartographie ESPN API | ✅ Actif (inchangé) |

---

*Document v4.4 — 2026-06-09*
*Remplace socle_nba_v4_3.md*
*Ajouts session 5 : OnboardingTuto livré (7 slides), équipes favorites Top 3 (Profil + MesPronos), fichier statique equipesNBA.js, MesPronos header v2 (3 colonnes, bio, chips, isMobile), philosophie app clarifiée, convention ligues = phases NBA, PRIORITÉ 1 soldée à 100%*
