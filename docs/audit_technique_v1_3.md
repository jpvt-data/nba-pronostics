# AUDIT TECHNIQUE — SWISH LEAGUE v1.3
...
OKC affichait en dernier (index 14) alors que seed 1.
...
SGA affichait 10.8 PPG (2018-19) au lieu de 31.1 PPG (2025-26).
...
**Sévérité :** 🟡 Moyenne
Toujours actif. Solution long terme : Edge Function Supabase (Phase 4.7).
...
ADMIN_ID côté client reste pour l'UI uniquement — sans risque côté serveur.
...
**Sévérité :** 🟢 Faible (acceptable, parallèle)
Pas de cache entre sessions. Amélioration possible : mémoriser en state ou sessionStorage.
...
| 4.4 | StandingsNBA Board : TOP 5 + lien "voir tout" → Stats/Explorer | 🔲 À FAIRE | Dépend de 4.2 ✅ |
| 4.5 | Win probability + Game Predictor dans MatchDetail | 🔲 À FAIRE | CORS validé ✅ |
| 4.6 | Sélecteur de saison dans Calendrier | 🔲 À FAIRE | Backlog Sprint 1 restant |
| 4.7 | Edge Function Supabase — calcul points serveur + verrou prono | 🔲 À FAIRE | Corrige RISQUE-02 |
| 4.8 | Bonus score exact + bonus série dans système de points | 🔲 À FAIRE | Nécessite 4.7 |
| 4.9 | IA Gemini — suggestions pronos, résumés matchs | 🔲 À FAIRE | |
| 4.10 | News FR via RSS + proxy Edge Function | 🔲 À FAIRE | Nécessite Edge Function |
...
- **Ce document ne remplace pas `socle_nba_v1.0.md`** — le socle reste la référence technique.

---

*Document v1.3 — 2026-05-28*
*Phases 0, 1, 2, 3 terminées. Phase 4 en cours (4.1, 4.2, 4.3 terminés). Prochaine révision : après 4.4-4.10.*
