...
> v2.7 — 2026-06-09 | PRIORITÉ 1 soldée — Onboarding + Équipes favorites + Header MesPronos

---

## 1. Situation actuelle

Swish League est une app mature, cohérente et enrichie. La PRIORITÉ 1 (avant Summer League juillet 2026) est **100% livrée**.

**Ce qui a été livré (Sprints 1→3.8 + Cotes + Sessions 3→5) :**
...
H2H ✅, MVP semaine ✅, chat Vestiaire ✅, streaks ✅. Prochain levier : collection de cartes.

### Pilier 3 — La progression visible
Streak ✅, RPG complet ✅, Bonus Écart ✅, Missions chaînées ✅, Roue ✅, Onboarding ✅, Équipes favorites ✅. Prochaine étape : avatars, filtrage pronos par équipes.
...
## 7. Système Tracking ✅ OPÉRATIONNEL
...
## 11. Off-season — stratégie rétention (juin → septembre)
...
*Ne pas fusionner avec socle_nba_v4_4.md (référence technique)*
