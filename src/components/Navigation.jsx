...
function Navigation({ nbPronosAttente = 0 }) {
  ...
  const LogoTeko = ({ size = 20 }) => (
    <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
      ...
      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 8, fontWeight: 500, color: 'var(--nav-text-dim)', letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1, marginTop: -3, paddingLeft: 1 }}>Pronostique · Flambe · Règne</span>
    </div>
  )
